...
public class NewModuleServicePossibleValuesService extends PossibleValuesService
{
    ...
    protected void initPossibleValuesService()
    {
        ...
        op().property( NewModuleOp.PROP_PROJECT_TEMPLATE_NAME ).attach( this.listener );
    }
    ...
    protected void compute( final Set<String> values )
    {
        ...
        final String template = op.getProjectTemplateName().content( true ).toString();
    ...
    public void dispose()
    {
        ...
        {
            op().property( NewModuleOp.PROP_PROJECT_TEMPLATE_NAME ).detach( this.listener );
