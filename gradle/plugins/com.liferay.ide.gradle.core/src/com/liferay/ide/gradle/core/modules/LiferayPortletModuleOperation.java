...
public class LiferayPortletModuleOperation extends LiferayAbstractGradleModuleOperation
{

    public LiferayPortletModuleOperation( NewModuleOp op )
    {
        super( op );
    }
        ...
        if( projectSrcFiles.size() > 0 )
        {
            ...
            try(FileInputStream fis = new FileInputStream( srcFile ))
            {
                ...
                if( !CoreUtil.isNullOrEmpty( property ) )
                {
                    ...
                    property = property.substring( 0, property.lastIndexOf( "\t" ) - 2 );
                    property += ",\n";
                    sb.append( property );
                }
