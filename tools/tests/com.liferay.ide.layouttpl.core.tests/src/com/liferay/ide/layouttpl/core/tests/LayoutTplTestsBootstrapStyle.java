 ...
 *
 */
public class LayoutTplTestsBootstrapStyle extends LayoutTplCoreTests
{
    ...
    public void evalTemplateFromChangedModel_1_3_2_nest_columns() throws Exception
    {
        ...
        LayoutTplDiagramElement layoutTpl = createModel_132_nest( isBootstrapStyle(), className );
    ...
    protected LayoutTplDiagramElement createModel_132_nest( boolean isBootstrapStyle, String className )
    {
