...
public interface ProjectWizard
{
    ...
    public final String TEXT_LAUNCH_NEW_PORTLET_WIZARD_AFTER_PROJECT = "Launch New Portlet Wizard after project is created";
    ...
    public final String TEXT_CREATE_NEW_PROJECT_AS_LIFERAY_PLUGIN = "Create a new project configured as a Liferay plugin";
    ...
    public final String TEXT_CHOOSE_AVAILABLE_PORTLET_FRAMEWORKS = "Choose from available portlet frameworks depending on which technology is most appropriate for this project.";
    public final String TEXT_PORTLET_FRAMEWORK_REQUIRES_SDK = "Selected portlet framework requires SDK version at least 7.0.0";
    ...
    public final String TEXT_PROJECT_EXISTS_IN_LOCATION =  " is not valid because a project already exists at that location.";
