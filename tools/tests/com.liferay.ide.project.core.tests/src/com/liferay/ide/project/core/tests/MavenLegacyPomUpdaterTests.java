 ...
 * @author Andy Wu
 */
public class MavenLegacyPomUpdaterTests
{
    ...
    private void importExistingProject( IPath projectPath )
    {
        try
        {
            final IWorkspace workspace = ResourcesPlugin.getWorkspace();
            final IProjectDescription description =
                workspace.loadProjectDescription( projectPath.append( ".project" ) );
    ...
    public void testUpgrade() throws Exception
    {
        ...
        final URL projectZipUrl =
            Platform.getBundle( "com.liferay.ide.project.core.tests" ).getEntry( "projects/testMavenProjects.zip" );
        ...
        importExistingProject( stateLocation.append( "testMavenProjects" ) );
        importExistingProject( stateLocation.append( "testMavenProjects/testpp" ) );
        importExistingProject( stateLocation.append( "testMavenProjects/testsb" ) );
        importExistingProject( stateLocation.append( "testMavenProjects/testsb/testsb-portlet" ) );
        importExistingProject( stateLocation.append( "testMavenProjects/testsb/testsb-portlet-service" ) );
        importExistingProject( stateLocation.append( "testMavenProjects/testtheme" ) );

        MavenLegacyPomUpdater updater = new MavenLegacyPomUpdater();
