...
//            op3.getProjectName().validation().message() );
    ...
    public void testIncludeSampleCode() throws Exception
    {
        ...
        assertEquals( 1, getElements( portletXml, "portlet" ).getLength() );
        assertEquals( 1, getElements( liferayPortletXml, "portlet" ).getLength() );
        assertEquals( 1, getElements( liferayDisplayXml, "category" ).getLength() );
        ...
        assertEquals( 1, getElements( liferayPortletXml, "portlet" ).getLength() );
        assertEquals( 1, getElements( liferayDisplayXml, "category" ).getLength() );
        assertEquals( 1, getElements( serviceXml, "entity" ).getLength() );
    }
