...
{
    protected LayoutTplDiagramElement modelElement;

    public LayoutTplPreviewEditor( LayoutTplDiagramElement layoutTpl )
    {
    ...
    public LayoutTplDiagramElement getModelElement()
    {
        return modelElement;
    }
    ...
    public void refreshVisualModel( LayoutTplDiagramElement layoutTpl )
    {
        final GraphicalViewer viewer = getGraphicalViewer();
        if( viewer != null )
        {
