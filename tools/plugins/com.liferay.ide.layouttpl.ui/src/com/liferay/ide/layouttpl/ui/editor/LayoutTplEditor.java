...
public class LayoutTplEditor extends SapphireEditor implements IExecutableExtension
{
    ...
    private static final String PREVIEW_PAGE_TITLE = "Previw";
    ...
    {
        this( LayoutTplDiagramElement.TYPE, DefinitionLoader.sdef( LayoutTplEditor.class ).page( "designPage" ) );
    }
    ...
    protected void createDiagramPages() throws PartInitException
    {
        ...
        if( element instanceof LayoutTplDiagramElement )
        {
            this.previewPage = new LayoutTplPreviewEditor( (LayoutTplDiagramElement) element );
        }
    ...
    protected Element createModel()
    {
        ...
        LayoutTplDiagramElement layoutTpl =
    ...
    protected void pageChange( int pageIndex )
    {
        ...
        if( lastActivePage == SOURCE_PAGE_INDEX && pageIndex == PREVIEW_PAGE_INDEX )
        {
            ...
            // then don't refresh the model element, since every time the model element got changed
            // the tree of outline view got collapsed
    ...
    {
        LayoutTplDiagramElement newElement = LayoutTplElementsFactory.INSTANCE.newLayoutTplFromFile( getFile(), isBootstrapStyle );
    ...
    {
        this.previewPage.refreshVisualModel( (LayoutTplDiagramElement) getModelElement() );
    }

    protected void refreshSourceModel()
    {
        refreshSourceModel( (LayoutTplDiagramElement) getModelElement() );
    }

    protected void refreshSourceModel( LayoutTplDiagramElement modelElement )
    {
        if( this.sourceModel != null )
        {
