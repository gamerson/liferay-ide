...
public class LayoutTplEditor extends SapphireEditor implements IExecutableExtension
{
    ...
    protected Element createModel()
    {
        ...
        LayoutTplElement layoutTpl = LayoutTplElementsFactory.INSTANCE.newLayoutTplFromFile( file, isBootstrapStyle ); 

        if( layoutTpl == null )
        {
            layoutTpl = createEmptyModel();
    ...
    protected LayoutTplElement createEmptyModel()
    {
    ...
    private int getLastActivePage()
    {
        ...
        try
        {
            ...
            if( prefs != null )
            {
                lastActivePage = prefs.getInt( "LastActivePage", lastActivePage );
            }
        }
