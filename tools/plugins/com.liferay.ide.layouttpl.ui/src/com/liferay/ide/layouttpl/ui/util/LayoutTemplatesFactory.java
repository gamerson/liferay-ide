...
public class LayoutTemplatesFactory {
	...
	public static void add_Layout_1(LayoutTplElement layoutTpl) {
		ElementList<PortletLayoutElement> layoutElements = layoutTpl.getPortletLayouts();

		PortletLayoutElement row = layoutElements.insert();

		ElementList<PortletColumnElement> columnElements = row.getPortletColumns();

		PortletColumnElement column = columnElements.insert();
	...
	public static void add_Layout_1_2_1(LayoutTplElement layoutTpl) {
		...
		PortletLayoutElement row1 = layoutElements.insert();

		ElementList<PortletColumnElement> columnElements1 = row1.getPortletColumns();

		PortletColumnElement column11 = columnElements1.insert();

		int fullWeight = SapphireUtil.getContent(column11.getFullWeight());

		column11.setWeight(fullWeight);

		PortletLayoutElement row2 = layoutElements.insert();

		ElementList<PortletColumnElement> columnElements2 = row2.getPortletColumns();

		PortletColumnElement column21 = columnElements2.insert();

		column21.setWeight(fullWeight / 2);

		PortletColumnElement column22 = columnElements2.insert();

		column22.setWeight(fullWeight / 2);

		PortletLayoutElement row3 = layoutElements.insert();

		ElementList<PortletColumnElement> columnElements3 = row3.getPortletColumns();

		PortletColumnElement column31 = columnElements3.insert();
	...
	public static void add_Layout_2_2(LayoutTplElement layoutTpl) {
		...
		PortletColumnElement column11 = columnElements1.insert();
		PortletColumnElement column12 = columnElements1.insert();
	...
	public static void add_Row_1(CanAddPortletLayouts element) {
		ElementList<PortletLayoutElement> layoutElements = element.getPortletLayouts();
	...
	public static void add_Row_2_I(CanAddPortletLayouts element) {
		...
		PortletColumnElement column1 = columnElements.insert();
		PortletColumnElement column2 = columnElements.insert();
	...
	public static void add_Row_3(CanAddPortletLayouts element) {
		...
		PortletColumnElement column1 = columnElements.insert();
		PortletColumnElement column2 = columnElements.insert();
		PortletColumnElement column3 = columnElements.insert();
