...
import com.liferay.ide.upgrade.plan.core.internal.OutlineListener;
...
public interface NewUpgradePlanOp extends ExecutableElement {
	...
	public ElementList<UpgradePlanProperty> getProperties();
	...
	@Type(base = UpgradePlanProperty.class)
	public ListProperty PROP_PROPERTIES = new ListProperty(TYPE, "Properties");
	...
	@Listeners(OutlineListener.class)
	@Required
