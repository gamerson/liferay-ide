...
public class RemoveDependencyVersionCommand implements UpgradeCommand {
	...
	public IStatus perform(IProgressMonitor progressMonitor) {
		List<File> buildGradleFiles = _geLiferayProjectBuildGradleFiles();
	...
	private List<File> _geLiferayProjectBuildGradleFiles() {
		...
		try {
			...
			dependencies.stream(
				...
				artifact -> {
					...
					try {
						gradleDependencyUpdater.updateVersion(false, artifact);
					}
