...
public class LiferayWorkspaceServerActionProvider extends CommonActionProvider {
	...
	private void _makeActions(IMenuManager menu, ISelectionProvider provider) {
		...
		if (selection instanceof TreeSelection) {
			...
			Job[] jobs = jobManager.find(GradleCore.LIFERAY_WATCH_DEPLOY_TASK);
			...
			if (workspaceProject != null) {
				...
				if (ListUtil.isNotEmpty(jobs) && ListUtil.contains(watchingProjects, workspaceProject.getProject())) {
				...
				TreePath[] selectionPaths = treeSelection.getPathsFor(selectedProject);
