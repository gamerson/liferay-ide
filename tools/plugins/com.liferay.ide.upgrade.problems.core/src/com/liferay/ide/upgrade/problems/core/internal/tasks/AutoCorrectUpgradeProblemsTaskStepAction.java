...
public class AutoCorrectUpgradeProblemsTaskStepAction extends BaseUpgradeTaskStepAction {

	@Override
	public IStatus perform() {
		UpgradePlan upgradePlan = _upgradePlanner.getCurrentUpgradePlan();

		Bundle bundle = FrameworkUtil.getBundle(AutoCorrectUpgradeProblemsTaskStepAction.class);
		...
		WorkspaceJob job = new WorkspaceJob("Auto correcting all breaking changes.") {
			...
			public IStatus runInWorkspace(IProgressMonitor monitor) {
				...
				_upgradePlanner.dispatch(
					new UpgradeTaskStepActionDoneEvent(AutoCorrectUpgradeProblemsTaskStepAction.this));
