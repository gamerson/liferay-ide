...
import com.liferay.ide.upgrade.problems.core.steps.AutoCorrectUpgradeProblemsActionKeys;
...
@Component(
	property = {
		...
		"id=" + AutoCorrectUpgradeProblemsActionKeys.ID, "order=2", "requirement=recommended", "parentId=",
		"title=" + AutoCorrectUpgradeProblemsActionKeys.TITLE
	},
	scope = ServiceScope.PROTOTYPE, service = UpgradeStep.class
)
public class AutoCorrectUpgradeProblemsAction extends BaseUpgradeStep {
