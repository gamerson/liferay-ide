...
public class PortalServiceImports70 extends JavaImportsMigrator {
	...
	private final String[] _modularizationPropertiesFileNames = {
		...
		"modularization-dynamic-data-lists-api.properties", "modularization-dynamic-data-lists-service.properties",
		"modularization-dynamic-data-mapping-api.properties", "modularization-flags-api.properties",
		"modularization-flags-service.properties", "modularization-journal-api.properties",
		"modularization-mobile-device-rules-api.properties", "modularization-polls-api.properties",
		"modularization-portal-background-task-api.properties", "modularization-portal-cache.properties",
		"modularization-portal-compound-session-id.properties", "modularization-portal-executor.properties",
		"modularization-portal-jmx-api.properties", "modularization-portal-jmx.properties",
		...
		"modularization-portal-rules-engine-api.properties", "modularization-portal-scripting-api.properties",
		"modularization-portal-search.properties", "modularization-portal-security-audit-api.properties",
		"modularization-portal-security-ldap.properties", "modularization-portlet-display-template.properties",
		"modularization-shopping-api.properties", "modularization-wiki-api.properties",
		"modularization-wiki-service.properties"
	};
