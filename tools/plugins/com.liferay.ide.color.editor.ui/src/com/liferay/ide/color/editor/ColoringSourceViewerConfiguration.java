...
import com.liferay.ide.color.editor.rules.CasedWordRule;
...
import com.liferay.ide.color.editor.rules.LToken;
...
public class ColoringSourceViewerConfiguration extends SourceViewerConfiguration {
	 ...
	 * 
	 */
	public final static String PREFERENCE_TAB_WIDTH = EditorPlugin.PLUGIN_ID + ".tab.width"; //$NON-NLS-1$
	/** 
