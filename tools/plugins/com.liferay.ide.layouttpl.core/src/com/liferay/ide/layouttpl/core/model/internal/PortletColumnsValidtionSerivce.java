...
public class PortletColumnsValidtionSerivce extends ValidationService
{
    ...
    protected Status compute()
    {
        ...
        final LayoutTplDiagramElement layoutTpl = portletLayout.nearest( LayoutTplDiagramElement.class );

        int actualWeightSum = 0;
        int weightSum = layoutTpl.getBootstrapStyle().content() ? 12 : 100;
