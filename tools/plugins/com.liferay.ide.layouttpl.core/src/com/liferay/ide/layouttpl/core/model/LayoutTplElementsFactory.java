...
public class LayoutTplElementsFactory
{
    ...
    public LayoutTplDiagramElement newLayoutTplFromFile( IFile file, Boolean isBootstrapStyle )
    {
        ...
        LayoutTplDiagramElement layoutTpl = null;
    ...
    public LayoutTplDiagramElement newLayoutTplFromModel( IDOMModel model, Boolean isBootstrapStyle )
    {
        if( model == null )
        {
            return null;
        ...
        {
            layoutTpl = LayoutTplDiagramElement.TYPE.instantiate();
