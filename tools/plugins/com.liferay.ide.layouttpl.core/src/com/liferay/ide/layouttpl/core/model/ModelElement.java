 ...
 * necessary for all model elements, like:</p> <ul> <li>property-change support
 * (used to notify edit parts of model changes),</li> <li>property-source
 * support (used to display property values in the Property View) and</li>
...
public abstract class ModelElement {
	 ...
	 * sheet. <p>My personal rule of thumb:</p> <ul> <li>model elements should
