...
public class PortalRuntimeComposite extends Composite implements ModifyListener
{
    ...
    private void createFields()
    {
        ...
        this.typeField = createReadOnlyTextField( Msgs.detectedBundleType );
    ...
    public void modifyText( ModifyEvent e )
    {
        ...
        if( getPortalRuntime().getVMInstall() != null )
        {
            // check to see if selected VM is in same path as new server
            // location
            IPath vmLoc = new Path( getPortalRuntime().getVMInstall().getInstallLocation().getPath() );
            ...
            if( !runtimeLoc.isPrefixOf( vmLoc ) )
            {
                ...
                PortalRuntime runtime = (PortalRuntime) getPortalRuntime();
    ...
    protected void updateJREs()
    {
        ...
        IVMInstall currentVM = portalRuntime!=null?portalRuntime.getVMInstall():null;
    ...
    private static class Msgs extends NLS
    {
        ...
        public static String detectedBundleType;
