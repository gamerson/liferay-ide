...
import com.liferay.ide.server.ui.action.OpenPropertiesFolderAction;
...
public class PropertiesActionProvider extends CommonActionProvider
{
    ...
    private OpenPropertiesFolderAction openFolderAction;
    ...
    private void makeActions( CommonViewer tableViewer, ISelectionProvider provider )
    {
        ...
        openFolderAction = new OpenPropertiesFolderAction( provider );
    }
