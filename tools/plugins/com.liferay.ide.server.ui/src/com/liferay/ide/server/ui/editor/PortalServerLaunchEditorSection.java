...
import com.liferay.ide.server.ui.cmd.SetUseDefaultPortalSeverSettingsCommand;
import com.liferay.ide.server.ui.cmd.SetUseDevelopmentServerModeCommand;
...
public class PortalServerLaunchEditorSection extends ServerEditorSection
{
    ...
    protected Button useDevelopmentServerMode;
    ...
    protected void addChangeListeners()
    {
        listener = new PropertyChangeListener()
        {
            ...
            public void propertyChange( PropertyChangeEvent event )
            {
                ...
                else if( PortalServer.PROPERTY_USE_DEVELOPMENT_SERVER_MODE.equals( event.getPropertyName() ) )
                {
                    boolean s = (Boolean) event.getNewValue();
                    useDevelopmentServerMode.setSelection( s );
                    validate();
                }
                else if( PortalServer.PROPERTY_USE_DEFAULT_PORTAL_SERVER_SETTINGS.equals( event.getPropertyName() ) )
                {
                    boolean s = (Boolean) event.getNewValue();
    ...
    private void applyDefaultPortalServerSetting( final boolean useDefaultPortalSeverSetting )
    {
        if( useDefaultPortalSeverSetting )
        {
            ...
            useDevelopmentServerMode.setEnabled( false );
        }
        else
        {
            ...
            useDevelopmentServerMode.setEnabled( true );
        }
    }
    ...
    public void createSection( Composite parent )
    {
        ...
        defaultLaunchSettings.addSelectionListener( new SelectionAdapter()
        {
            ...
            {
                updating = true;
                execute( new SetUseDefaultPortalSeverSettingsCommand( server, defaultLaunchSettings.getSelection() ) );
                updating = false;
        ...
        customLaunchSettings.addSelectionListener( new SelectionAdapter()
        {
            ...
            {
                updating = true;
                execute( new SetUseDefaultPortalSeverSettingsCommand( server, !customLaunchSettings.getSelection() ) );
                updating = false;
        ...
        label = createLabel( toolkit, composite, Msgs.useDeveloperMode );
        data = new GridData( SWT.BEGINNING, SWT.CENTER, false, false );
        label.setLayoutData( data );

        useDevelopmentServerMode = new Button( composite, SWT.CHECK );
        useDevelopmentServerMode.setText( Msgs.useDevelopmentServerMode );
        data = new GridData( SWT.FILL, SWT.CENTER, true, false );
        useDevelopmentServerMode.setLayoutData( data );

        useDevelopmentServerMode.addSelectionListener( new SelectionAdapter()
        {
            ...
            public void widgetSelected( SelectionEvent e )
            {
                if( updating )
                    return;
                updating = true;
                execute( new SetUseDevelopmentServerModeCommand( server, useDevelopmentServerMode.getSelection() ) );
                updating = false;
                validate();
            }
        ...
        setDefault.addHyperlinkListener( new HyperlinkAdapter()
        {
            ...
            public void linkActivated( HyperlinkEvent e )
            {
                ...
                execute( new SetUseDevelopmentServerModeCommand(
                    server, PortalServerConstants.DEFAULT_USE_DEVELOPMENT_SERVER_MODE ) );
                useDevelopmentServerMode.setSelection( PortalServerConstants.DEFAULT_USE_DEVELOPMENT_SERVER_MODE );

                execute( new SetUseDefaultPortalSeverSettingsCommand(
                    server, PortalServerConstants.DEFAULT_USE_DEFAULT_PORTAL_SERVER_SETTING ) );
                defaultLaunchSettings.setSelection( PortalServerConstants.DEFAULT_USE_DEFAULT_PORTAL_SERVER_SETTING );
                customLaunchSettings.setSelection( !PortalServerConstants.DEFAULT_USE_DEFAULT_PORTAL_SERVER_SETTING );
                applyDefaultPortalServerSetting( PortalServerConstants.DEFAULT_USE_DEFAULT_PORTAL_SERVER_SETTING );
    ...
    protected void initialize()
    {
        ...
        useDevelopmentServerMode.setSelection( portalServer.getUseDevelopmentServerMode() );
        defaultLaunchSettings.setSelection( portalServer.getUseDefaultPortalServerSettings() );
        customLaunchSettings.setSelection( !portalServer.getUseDefaultPortalServerSettings() );
        applyDefaultPortalServerSetting( portalServer.getUseDefaultPortalServerSettings() );
    ...
    private static class Msgs extends NLS
    {
        ...
        public static String useDevelopmentServerMode;
