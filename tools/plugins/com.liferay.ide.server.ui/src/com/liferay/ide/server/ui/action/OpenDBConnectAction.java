 ...
 * @author Simon Jiang
 */
public class OpenDBConnectAction extends AbstractServerRunningAction
{
    ...
    private static class Msgs extends NLS
    {
        ...
        static
        {
            initializeMessages( OpenDBConnectAction.class.getName(), Msgs.class );
        }
    }
}
