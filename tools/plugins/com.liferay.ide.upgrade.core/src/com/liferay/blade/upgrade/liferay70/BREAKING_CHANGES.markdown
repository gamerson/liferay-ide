...
### Deprecated the social.activity.sets.enabled Property with No Direct Replacement [](id=deprecated-the-social-activity-sets-enabled-Property)
- **Date:** 2018-Jan-24
- **JIRA Ticket:** LPS-63635

#### What changed? [](id=what-changed-113)
...
#### Who is affected? [](id=who-is-affected-113)

This change affects anyone who has set the `social.activity.sets.enabled`
property to `false`.

#### How should I update my code? [](id=how-should-i-update-my-code-113)

No changes are necessary.

#### Why was this change made? [](id=why-was-this-change-made-113)
