...
public class ProjectMavenPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage
{
    ...
    public static final String ID = "com.liferay.ide.project.ui.projectMavenPreferencePage";
    ...
    protected void createFieldEditors()
    {
        ...
        disableCustomJspValidation =
            new BooleanFieldEditor(
                ProjectCore.PREF_DISABLE_CUSTOM_JSP_VALIDATION, "Disable custom jsp validation checking",
    ...
    public IPreferenceStore getPreferenceStore()
    {
        if( prefStore == null )
        {
            ...
            prefStore.setDefault( ProjectCore.PREF_DISABLE_CUSTOM_JSP_VALIDATION, true );
        }
