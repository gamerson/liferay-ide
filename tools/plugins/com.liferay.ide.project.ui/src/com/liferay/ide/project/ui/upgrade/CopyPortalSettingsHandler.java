...
import com.liferay.ide.project.core.model.LiferayPortalSetup;
import com.liferay.ide.project.core.util.LiferayUpgradeUtil;
...
public class CopyPortalSettingsHandler extends AbstractOSGiCommandHandler
{
    ...
    public static final Status execute( final CopyPortalSettingsOp op, final ProgressMonitor pm )
    {
        ...
        try
        {
            LiferayUpgradeUtil.JavaObjectToJSONFile(
                ProjectUI.getDefault().getStateLocation().toOSString(), new LiferayPortalSetup(
