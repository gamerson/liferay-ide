    ...
    implements IWorkbenchWizard, INewWizard
{
    ...
    private void removeSampleCode( IProject project, PluginType pluginType )
    {
        ...
        {
            extensions.add( registry.getExtension( "com.liferay.ide.portlet.core.portletDescriptorHelper" ) );
        }

        if( pluginType.equals( PluginType.servicebuilder ) )
        {
            extensions.add( registry.getExtension( "com.liferay.ide.portlet.core.portletDescriptorHelper" ) );
            extensions.add( registry.getExtension( "com.liferay.ide.service.core.serviceBuilderDescriptorHelper" ) );
        }
        ...
        for( IExtension extension : extensions )
        {
            ...
            {
                if( "liferayDescriptorHelper".equals( element.getName() ) )
                {
                    try
                    {
                        final LiferayDescriptorHelper descriptorHelper =
                                (LiferayDescriptorHelper) CoreUtility.createExtension( element, "class" );
                        descriptorHelper.setProject( project );
                        descriptorHelper.removeSampleElements();
                    }
    ...
    private void openNewPortletWizard()
    {
        ...
        final IExtension extension =
            registry.getExtension( "com.liferay.ide.portlet.ui.newPortletWizard" );
