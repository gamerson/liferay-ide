...
public class AddJSPsFromOSGiBundleAction extends SapphireActionHandler
{
    ...
    {
        NewLiferayModuleProjectOp op = context.part().getModelElement().nearest( NewLiferayModuleProjectOp.class );
        ...
        PortalBundle portalBundle = LiferayServerCore.getPortalBundle( runtime.getLocation() );
