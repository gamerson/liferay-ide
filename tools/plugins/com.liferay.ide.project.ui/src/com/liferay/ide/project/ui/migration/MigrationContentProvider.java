...
public class MigrationContentProvider implements ITreeContentProvider
{
    ...
    List<UpgradeProblems> _problems;
    ...
    public void inputChanged( Viewer viewer, Object oldInput, Object newInput )
    {
        ...
        {
            _problems = new ArrayList<UpgradeProblems>();
            ...
            try
            {
                ...
                Object[] o = UpgradeAssistantSettingsUtil.getAllObjectFromStore( CodeMigrationProblems.class );
                ...
                if( o != null && o.length > 0 )
                {
                    for( Object object : o )
                    {
                        if( object instanceof CodeMigrationProblems )
                        {
                            _problems.add( (CodeMigrationProblems) object );
                        }
