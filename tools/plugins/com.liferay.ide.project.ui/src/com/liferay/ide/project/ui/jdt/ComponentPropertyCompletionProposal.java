...
public class ComponentPropertyCompletionProposal extends JavaCompletionProposal       
{
    ...
    public ComponentPropertyCompletionProposal(
        ...
        Image image, String displayString, int relevance, int replacementStart, int replacementEnd , String addtionalString )
    {
    ...
    public boolean validate( IDocument document, int offset, DocumentEvent event )
    {
        ...
        if ( fIsValidated )
        {
            setReplaceEnd( getReplaceStart() +  prefix.length() );
        }
