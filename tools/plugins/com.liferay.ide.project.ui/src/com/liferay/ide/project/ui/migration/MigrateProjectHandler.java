        ...
        Job job = new WorkspaceJob( "Finding migration problems..." )
        {
            ...
            public IStatus runInWorkspace( final IProgressMonitor monitor ) throws CoreException
            {
                ...
                try
                {
                    ...
                    {
                        CodeMigrationProblems cp = new CodeMigrationProblems();

                        FileProblems fileProblems = new FileProblems();

                        fileProblems.setProblems( allProblems );

                        cp.setProblems( FileProblemsUtil.getFileProblemsArray( allProblems.toArray( new Problem[0] ) ).toArray(
                            new FileProblems[0] ) );
                        ...
                        {
                            UpgradeAssistantSettingsUtil.setObjectToStore( CodeMigrationProblems.class, projectName, cp );
                        }
                        else
                        {
                            UpgradeAssistantSettingsUtil.setObjectToStore( CodeMigrationProblems.class, cp );
                        }
