...
public abstract class AbstractEditorMarkerResolution extends WorkbenchMarkerResolution
{
    ...
    public AbstractEditorMarkerResolution( IMarker marker )
    {
    ...
    public IMarker[] findOtherMarkers( IMarker[] markers )
    {
        ...
        IMarker[] otherMarkersArray = new IMarker[otherMarkers.size()];

        return otherMarkers.toArray( otherMarkersArray );
    }
