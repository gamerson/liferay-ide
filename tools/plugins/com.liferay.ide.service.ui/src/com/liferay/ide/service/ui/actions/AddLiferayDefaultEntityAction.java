 ...
 * @author Kuo Zhang
 */
public class AddLiferayDefaultEntityAction extends SapphireActionHandler
{

    @Override
    protected Object run( Presentation context )
    {
        IFile serviceXML = context.part().getLocalModelElement().adapt( IFile.class );
    ...
    public AddLiferayDefaultEntityAction()
    {
        super();
    }
