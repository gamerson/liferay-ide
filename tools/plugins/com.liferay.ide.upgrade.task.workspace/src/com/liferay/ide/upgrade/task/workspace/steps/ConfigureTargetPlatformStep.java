 ...
 * @author Terry Jia
 */
@Component(properties = "OSGI-INF/ConfigureTargetPlatformStep.properties", service = UpgradeTaskStep.class)
public class ConfigureTargetPlatformStep extends WorkspaceUpgradeTaskStep {
