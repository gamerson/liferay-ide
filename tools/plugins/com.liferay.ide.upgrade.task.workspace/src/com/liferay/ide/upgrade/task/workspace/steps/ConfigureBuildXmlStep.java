 ...
 * @author Terry Jia
 */
@Component(properties = "OSGI-INF/ConfigureBuildXmlStep.properties", service = UpgradeTaskStep.class)
public class ConfigureBuildXmlStep extends WorkspaceUpgradeTaskStep {
