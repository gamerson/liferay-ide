 ...
 * @author Simon Jiang
 */
public abstract class AbstractBundlePublishFullRemove extends AbstractBundlePublishOperation
{

    public AbstractBundlePublishFullRemove( IServer server, IModule[] modules, BundleDTO[] existingBundles )
    {
