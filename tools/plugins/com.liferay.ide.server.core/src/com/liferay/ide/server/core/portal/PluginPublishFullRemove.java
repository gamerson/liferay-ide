 ...
 * @author Terry Jia
 */
public class PluginPublishFullRemove extends BundlePublishOperation
{

    public PluginPublishFullRemove( IServer server, IModule[] modules )
    {
    ...
    public void execute( IProgressMonitor monitor, IAdaptable info ) throws CoreException
    {
        for( IModule module : modules )
        {
            ...
            final PluginsSDKBundleProject project = LiferayCore.create( PluginsSDKBundleProject.class, module.getProject() );

            if( project != null )
            {
                final String symbolicName = project.getProject().getName();
