...
public class NewLiferayComponentGogoComandOperation extends BaseNewLiferayComponentOperation
{

    private static final String TEMPLATE_FILE = "gogocommand.ftl";

    private final static String EXTENSION_CLASS = "Object.class";

    private final static String[] PROPERTIES_LIST = new String[] { "osgi.command.scope=blade" };
