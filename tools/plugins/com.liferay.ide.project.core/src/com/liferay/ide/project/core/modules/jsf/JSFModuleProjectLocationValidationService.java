 ...
 *
 *******************************************************************************/
package com.liferay.ide.project.core.modules.jsf;
 ...
 * @author Simon Jiang
 */
public class JSFModuleProjectLocationValidationService extends ValidationService
{
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            final IStatus locationStatus =
                                op().getJsfProjectProvider().content().validateProjectLocation( currentProjectName, osPath );
    ...
    public void dispose()
    {
        ...
        if( this.listener != null )
        {
            ...
            op().getJsfProjectProvider().detach( this.listener );
            this.listener = null;
        }
    }
    ...
    protected void initValidationService()
    {
        ...
        op().getJsfProjectProvider().attach( this.listener );
    }
