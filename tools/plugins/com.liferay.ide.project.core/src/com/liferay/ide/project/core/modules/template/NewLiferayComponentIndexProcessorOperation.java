...
public class NewLiferayComponentIndexProcessorOperation extends BaseNewLiferayComponentOperation
{

    private static final String TEMPLATE_FILE = "indexprocessor.ftl";
