...
public class NewLiferayComponentPollerProcessorOperation extends BaseNewLiferayComponentOperation
{
    ...
    protected void doMergeResourcesOperation() throws CoreException
    {
        try
        {
            ...
            {
                CoreUtil.createEmptyFile( contentFolder.getFile( new Path( className + "/Language.properties" ) ) );
            }
            ...
            {
                CoreUtil.createEmptyFile( metaFolder.getFile( new Path( className + "/js/main.js" ) ) );
            }
