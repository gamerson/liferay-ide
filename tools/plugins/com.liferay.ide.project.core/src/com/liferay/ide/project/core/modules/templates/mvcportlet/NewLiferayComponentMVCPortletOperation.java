...
public class NewLiferayComponentMVCPortletOperation extends AbstractLiferayComponentTemplate
{
    ...
    {
        bndProperty.addKeyList( "-jsp" );
        bndProperty.put( "-jsp", "*.jsp,*.jspf" );

        bndProperty.addKeyList( "-plugin.bundle" );
        bndProperty.put( "-plugin.bundle","com.liferay.ant.bnd.resource.bundle.ResourceBundleLoaderAnalyzerPlugin");

        bndProperty.addKeyList( "-plugin.jsp" );
        bndProperty.put( "-plugin.jsp", "com.liferay.ant.bnd.jsp.JspAnalyzerPlugin");
