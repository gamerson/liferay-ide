 ...
 * @author Simon Jiang
 */
public interface SDKImportOp extends ExecutableElement
{

    ElementType TYPE = new ElementType( SDKImportOp.class );
    ...
    @Override
    @DelegateImplementation( SDKImportOpMethods.class )
