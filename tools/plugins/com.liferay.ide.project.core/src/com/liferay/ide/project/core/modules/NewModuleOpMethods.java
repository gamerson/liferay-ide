    ...
    public static final Status execute( final NewModuleOp op, final ProgressMonitor pm )
    {
        ...
        try
        {
            ...
            if ( project != null )
            {
                ...
                IDSComponentProvider componentProvider = liferayProject.adapt( IDSComponentProvider.class );
                
                if ( componentProvider != null )
                {
                    componentProvider.createNewModule( op, monitor );
                }
                else
                {
                    return Status.createErrorStatus( "Can't find valid DS component provider." );
                }
            }
            else
            {
