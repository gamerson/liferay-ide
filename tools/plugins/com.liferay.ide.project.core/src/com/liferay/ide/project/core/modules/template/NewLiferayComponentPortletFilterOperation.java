...
public class NewLiferayComponentPortletFilterOperation extends BaseNewLiferayComponentOperation
{
	private static final String PORTLET_FILTER_TEMPLATE_FILE = "portletfilter.ftl";
