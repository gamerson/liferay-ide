...
import com.liferay.ide.project.core.model.ParentSDKProjectImportOpMethods;
        ...
        try
        {
            ...
            else
            {
                ...
                if( currentProjectLocation != null && !currentProjectLocation.isEmpty() )
                {
                    ...
                    if ( sdk != null )
                    {
                        IStatus propertiesStatus = ParentSDKProjectImportOpMethods.validateBuildProperties( sdk );
                        retval = StatusBridge.create( propertiesStatus );
                    }
                    else
                    {
                        retval = Status.createErrorStatus( "This sdk import path is invalid." );
                    }
                }
            }
        }
