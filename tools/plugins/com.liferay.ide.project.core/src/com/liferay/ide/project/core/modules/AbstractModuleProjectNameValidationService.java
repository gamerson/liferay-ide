 ...
 * @author Simon Jiang
 */
public abstract class AbstractModuleProjectNameValidationService<T extends ExecutableElement> extends ValidationService
{
        ...
        listener = new FilteredListener<PropertyContentEvent>()
        {
            ...
            protected void handleTypedEvent( PropertyContentEvent event )
            {
                if( !event.property().definition().equals( BaseModuleOp.PROP_FINAL_PROJECT_NAME ) &&
                    ...
                    !event.property().definition().equals( getProjectNameValueProperty() ) )
                {
                    refresh();
                }
            }
    ...
    protected Status compute()
    {
        ...
        final String currentProjectName = getData( "ProjectNameValue", String.class );
        ...
        if( !CoreUtil.empty( currentProjectName ) )
        {
            ...
            final Path currentProjectLocation = getData( "LocationValue", Path.class );
    ...
    protected abstract <A> A getData( String key, Class<A> type );
