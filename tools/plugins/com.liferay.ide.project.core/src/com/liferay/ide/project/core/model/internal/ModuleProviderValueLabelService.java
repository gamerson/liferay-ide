 ...
 * @author Simon Jiang
 */
public class ModuleProviderValueLabelService extends ValueLabelService
{

    @Override
    public String provide( String value )
    {
        ILiferayOsgiModuleProvider provider = LiferayCore.getModuleProvider( value );

        return provider != null ? provider.getProjectType() : value;
    }
    ...
    public static class Condition extends ServiceCondition
    {
        ...
        public boolean applicable( final ServiceContext context )
        {
            ...
            if( prop != null && prop.equals( NewModuleOp.PROP_MODULE_PROVIDER ) )
            {
                retval = true;
            }
