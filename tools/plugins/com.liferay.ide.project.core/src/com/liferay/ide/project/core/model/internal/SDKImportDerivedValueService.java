...
public class SDKImportDerivedValueService extends DerivedValueService
{
    ...
    protected void initDerivedValueService()
    {
        ...
        op().property( SDKImportOp.PROP_SDK_LOCATION ).attach( this.listener );
    }
        ...
        if( op().getSdkLocation() != null )
        {
            if( op().getSdkLocation().content() != null && !op().getSdkLocation().content().isEmpty() )
            {
                ...
                final IStatus status =
                    ProjectImportUtil.validateSDKPath( op().getSdkLocation().content().toPortableString() );
    ...
    public void dispose()
    {
        if( op() != null )
        {
            op().property( SDKImportOp.PROP_SDK_LOCATION ).detach( this.listener );
        }
