...
public class NewLiferayComponentAuthFailureOperation extends BaseNewLiferayComponentOperation
{

    private static final String TEMPLATE_FILE = "authfailure.ftl";
