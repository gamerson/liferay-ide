...
public class NewLiferayComponentAuthenticatorOperation extends BaseNewLiferayComponentOperation
{

    private static final String TEMPLATE_FILE = "authenticator.ftl";
