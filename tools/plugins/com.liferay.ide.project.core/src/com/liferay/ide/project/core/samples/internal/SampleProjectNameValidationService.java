 ...
 * @author Terry Jia
 */
public class SampleProjectNameValidationService extends ValidationService implements SapphireContentAccessor {
	...
	protected Status compute() {
		try {
			if (!LiferayWorkspaceUtil.hasGradleWorkspace()) {
				return Status.createErrorStatus("This wizard only works for gradle liferay workspace.");
			}
		}
