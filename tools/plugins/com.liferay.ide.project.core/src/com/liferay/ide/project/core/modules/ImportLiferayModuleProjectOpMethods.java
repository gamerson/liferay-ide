...
public class ImportLiferayModuleProjectOpMethods
{
    ...
    public static final Status execute( final ImportLiferayModuleProjectOp op, final ProgressMonitor pm )
    {
        ...
        try
        {
            ...
            ILiferayProjectImporter[] importers = LiferayCore.getImporter( buildType );

            importers[0].importProject( location , monitor );
    ...
    public static String getBuildType( String location )
    {
        ...
        if( ProjectUtil.isMavenProject( location ) )
        {
            buildType = "maven";
        }
        else if( ProjectUtil.isGradleProject( location ) )
        {
            buildType = "gradle";
        }
