...
import com.liferay.ide.upgrade.planner.api.UpgradeTaskStep;
import com.liferay.ide.upgrade.planner.ui.UpgradeInfoPage;
import com.liferay.ide.upgrade.planner.ui.UpgradeInfoView;
	...
	private void _addListener() {
		...
		if (upgradeInfoView != null) {
			...
			if (upgradeInfoPage != null) {
				expansionListener = upgradeInfoPage;
			}
		}
