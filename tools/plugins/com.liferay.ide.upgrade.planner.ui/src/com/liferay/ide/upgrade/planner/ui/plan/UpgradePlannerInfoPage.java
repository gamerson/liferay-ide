 ...
 */
public class UpgradePlannerInfoPage extends Page implements ISelectionChangedListener, IExpansionListener {
...
//			}
	...
	protected UpgradePlannerInfoPage() {
		IViewPart projectExplorer = UIUtil.findView("org.eclipse.ui.navigator.ProjectExplorer");
		...
		IViewPart upgradePlannerView = UIUtil.findView(UpgradePlannerView.ID);

		if (upgradePlannerView != null) {
			IWorkbenchPartSite workbenchPartSite = upgradePlannerView.getSite();
