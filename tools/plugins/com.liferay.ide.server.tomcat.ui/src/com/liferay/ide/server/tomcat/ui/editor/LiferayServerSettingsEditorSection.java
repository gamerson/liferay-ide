...
import com.liferay.ide.server.tomcat.ui.command.SetPasswordCommand;
...
import com.liferay.ide.server.tomcat.ui.command.SetUsernameCommand;
...
//		deployDirBrowse.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, false, false));
		...
		*/
        ...
        textUsername = toolkit.createText( composite, null );
        ...
        textUsername.addModifyListener( new ModifyListener()
        {
            ...
            public void modifyText( ModifyEvent e )
            {
                ...
                updating = true;
                execute( new SetUsernameCommand( tomcatServer, textUsername.getText().trim() ) );
                updating = false;
            }
        ...
        textPassword = toolkit.createText( composite, null, SWT.PASSWORD );
        ...
        textPassword.addModifyListener( new ModifyListener()
        {
            ...
            public void modifyText( ModifyEvent e )
            {
                ...
                updating = true;
                execute( new SetPasswordCommand( tomcatServer, textPassword.getText().trim() ) );
                updating = false;
            }
...
//		autoDeployInterval.setText(tomcatServer.getAutoDeployInterval());
        ...
        textUsername.setText( this.tomcatServer.getUsername() );
        textPassword.setText( this.tomcatServer.getPassword() );
