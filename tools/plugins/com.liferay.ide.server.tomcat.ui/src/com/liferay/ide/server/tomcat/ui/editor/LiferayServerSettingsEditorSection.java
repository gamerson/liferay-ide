...
import com.liferay.ide.server.tomcat.ui.command.SetServerModelCommand;
...
//	protected Button deployDirBrowse;
    ...
    protected Button standardServerModel;
    protected Button developmentServerModel;
	...
	protected void addChangeListeners() {
		listener = new PropertyChangeListener() {
			public void propertyChange(PropertyChangeEvent event) {
				...
				else if (ILiferayTomcatServer.PROPERTY_SERVER_MODEL.equals(event.getPropertyName())) {
                    int s = (Integer) event.getNewValue();
                    standardServerModel.setSelection( s == ILiferayTomcatConstants.STANDARD_SERVER_MODEL );
                    developmentServerModel.setSelection( s == ILiferayTomcatConstants.DEVELOPMENT_SERVER_MODEL );
                    validate();
                }
...
//		deployDirBrowse.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, false, false));
        ...
        Group group = SWTUtil.createGroup( composite, Msgs.serverModel, 1 );
        ...
        standardServerModel = new Button( group, SWT.RADIO );
        standardServerModel.setText( ILiferayTomcatConstants.LABEL_STANDARD_SERVER_MODEL );
        standardServerModel.addSelectionListener( new SelectionAdapter()
        {
            ...
            {
                updating = true;
                execute( new SetServerModelCommand( tomcatServer, ILiferayTomcatConstants.STANDARD_SERVER_MODEL ) );
                updating = false;
            }
        } );

        developmentServerModel = new Button( group, SWT.RADIO );
        developmentServerModel.setText( ILiferayTomcatConstants.LABEL_DEVELOPMENT_SERVER_MODEL );
        developmentServerModel.addSelectionListener( new SelectionAdapter()
        {
            ...
            {
                updating = true;
                execute( new SetServerModelCommand( tomcatServer, ILiferayTomcatConstants.DEVELOPMENT_SERVER_MODEL ) );
                updating = false;
            }
        } );
		...
		setDefault.addHyperlinkListener(new HyperlinkAdapter() {
			public void linkActivated(HyperlinkEvent e) {
                ...
                execute( new SetServerModelCommand( tomcatServer, tomcatServer.getDefaultServerModel() ) );
                standardServerModel.setSelection(
                    tomcatServer.getDefaultServerModel() == ILiferayTomcatConstants.STANDARD_SERVER_MODEL );
                developmentServerModel.setSelection(
                    tomcatServer.getDefaultServerModel() == ILiferayTomcatConstants.DEVELOPMENT_SERVER_MODEL );
				updating = false;
				validate();
			}
		});
...
//		deployDir.setText(tomcatServer.getDeployDirectory());
        ...
        standardServerModel.setSelection(
            tomcatServer.getServerModel() == ILiferayTomcatConstants.STANDARD_SERVER_MODEL );
        developmentServerModel.setSelection(
            tomcatServer.getServerModel() == ILiferayTomcatConstants.DEVELOPMENT_SERVER_MODEL );
...
//		}
    ...
    private static class Msgs extends NLS
    {
        ...
        public static String serverModel;
