 ...
 * @author Simon Jiang
 */
public final class ClassImplBrowseActionHandler extends BrowseActionHandler
{

    public static final String ID = "ClassImpl.Browse.Java.Type"; //$NON-NLS-1$
        ...
        try
        {
            ...
            else
            {
                MessageDialog.openInformation(
                    ( (SwtPresentation) context ).shell(), Msgs.classImplBrowse, Msgs.validClassImplProperty );
    ...
    private static class Msgs extends NLS
    {
        ...
        public static String classImplBrowse;
        public static String validClassImplProperty;

        static
        {
            initializeMessages( ClassImplBrowseActionHandler.class.getName(), Msgs.class );
        }
    }
}
