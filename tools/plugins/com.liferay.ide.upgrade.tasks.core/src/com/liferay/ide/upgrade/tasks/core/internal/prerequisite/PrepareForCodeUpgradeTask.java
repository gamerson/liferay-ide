...
@Component(
	property = {
		"categoryId=code", "description=" + PrepareForCodeUpgradeTaskKeys.DESCRIPTION, "id=" + PrepareForCodeUpgradeTaskKeys.ID,
		"imagePath=icons/migrate_plugins_sdk.png", "order=4", "title=" + PrepareForCodeUpgradeTaskKeys.TITLE
	},
