...
import com.liferay.ide.upgrade.tasks.core.code.ImportLiferayWorkspaceActionKeys;
 ...
 */
@Component(
	property = {"id=" + ImportLiferayWorkspaceActionKeys.ID, "title=" + ImportLiferayWorkspaceActionKeys.TITLE},
