 ...
 */
@Component(
	property = {"id=init_bundle", "order=1", "stepId=init_bundle", "title=Init Bundle"}, scope = ServiceScope.PROTOTYPE,
	service = UpgradeTaskStepAction.class
)
public class InitBundleTaskStepAction extends BaseUpgradeTaskStepAction {
