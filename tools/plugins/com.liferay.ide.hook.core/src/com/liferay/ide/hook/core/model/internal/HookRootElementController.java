...
public class HookRootElementController extends VersionedDTDRootElementController {
	...
	public HookRootElementController() {
		super(_XML_BINDING_PATH, _PUBLIC_ID_TEMPLATE, _SYSTEM_ID_TEMPLATE, _publicIdPattern, _systemIdPattern);
	}
	...
	private static final String _XML_BINDING_PATH = Hook6xx.class.getAnnotation(XmlBinding.class).path();
