...
public interface HeaderPortletCss extends PortletStyleElement
{
    ...
    ValueProperty PROP_HEADER_PORTLET_CSS = new ValueProperty( TYPE, "HeaderPortletCss" );

    Value<Path> getHeaderPortletCss();

    void setHeaderPortletCss( String value );

    void setHeaderPortletCss( Path value );
}
