...
public interface TriggerTest extends Element, Identifiable, Describeable
{

    ElementType TYPE = new ElementType( TriggerTest.class );
    ...
    ElementProperty PROP_TRIGGER = new ElementProperty( TYPE, "Trigger" );

    ElementHandle<ITrigger> getHeterogeneous();
