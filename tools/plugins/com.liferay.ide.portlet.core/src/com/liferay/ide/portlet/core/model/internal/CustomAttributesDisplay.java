...
public interface CustomAttributesDisplay extends Element
{
    ...
    ValueProperty PROP_CUSTOM_ATTRIBUTES_DISPLAY = new ValueProperty( TYPE, "CustomAttributesDisplay" );

    ReferenceValue<JavaTypeName, JavaType> getCustomAttributesDisplay();
    void setCustomAttributesDisplay( String value );
    void setCustomAttributesDisplay( JavaTypeName value );
