...
import com.liferay.ide.portlet.core.model.internal.IconRelativePathService;
import com.liferay.ide.portlet.core.model.internal.IndexerClass;
import com.liferay.ide.portlet.core.model.internal.LiferayScriptPossibleValuesService;
import com.liferay.ide.portlet.core.model.internal.PortletNameValidationService;
import com.liferay.ide.portlet.core.model.internal.PortletStyleValidationService;
...
public interface LiferayPortlet extends Element 
{
    ...
    @Required
    @Unique
    @Service( impl = PortletNameValidationService.class )
...
//    @Service( impl = StrutsPathValidationSerivce.class )
...
//    social-activity-interpreter-class*
    ...
    (
        mappings = @XmlListBinding.Mapping
        (
            element = "social-activity-interperter-class",
    ...
    Value<Path> getUserNotificationDefinitions( Path value );
    ...
    ElementList<UserNotificationHandlerClass> getUserNotificationClasses();
    ...
    @XmlBinding( path = "webdav_storage-token" )
...
//    permission-propagator? 
    ...
    ValueProperty PROP_PERSSION_PROPAGATOR = new ValueProperty( TYPE, "PermissionPropagator" );
...
//    user-principal-strategy? 
    ...
    @XmlBinding( path = "user-principal-strrategy" )
...
//    header-portal-css*
    ...
    ElementList<HeaderPortletCss> getHeaderPortalCsses();
