...
public class EntryTemplate
 {
  ...
  protected final String TEXT_12 = "    /**" + NL + "     * Control panel entry class ";
  protected final String TEXT_13 = NL + "    */" + NL;
  protected final String TEXT_14 = NL + NL + "    /**" + NL + "     * Default constructor. " + NL + "     */" + NL + "    public ";
  protected final String TEXT_15 = "() {" + NL + "    }";
  protected final String TEXT_16 = NL + "       " + NL + "    /**" + NL + "     * @see ";
  ...
  protected final String TEXT_23 = NL + NL + "    @Override" + NL + "    public boolean isVisible(PermissionChecker permissionChecker, Portlet portlet)" + NL + "            throws Exception {" + NL + "        return false;" + NL + "    }" + NL + "" + NL + "}";
