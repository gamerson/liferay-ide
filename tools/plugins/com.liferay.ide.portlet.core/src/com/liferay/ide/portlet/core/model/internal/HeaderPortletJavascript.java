...
public interface HeaderPortletJavascript extends PortletStyleElement
{
    ...
    ValueProperty PROP_HEADER_PORTLET_JAVASCRIPT = new ValueProperty( TYPE, "HeaderPortletJavascript" );

    Value<Path> getHeaderPortletJavascript();

    void setHeaderPortletJavascript( String value );

    void setHeaderPortletJavascript( Path value );
