...
public interface AtomCollectionAdapter extends Element
{
    ...
    @MustExist
    @XmlBinding( path = "" )
    ValueProperty PROP_ATOM_COLLECTION_ADAPTER = new ValueProperty( TYPE, "AtomCollectionAdapter" );

    ReferenceValue<JavaTypeName, JavaType> getAtomCollectionAdapter();
    void setAtomCollectionAdapter( JavaTypeName value );
    void setAtomCollectionAdatper( String value );
}
