...
public interface FooterPortletCss extends PortletStyleElement
{
    ...
    ValueProperty PROP_FOOTER_PORTLET_CSS = new ValueProperty( TYPE, "FooterPortletCss" );

    Value<Path> getFooterPortletCss();
    void setFooterPortletCss( String value );
    void setFooterPortletCss( Path value );
}
