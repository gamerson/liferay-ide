...
public interface LiferayPortletApp extends Element
{
    ...
    @Type( base = RoleMapper.class )
    @XmlListBinding( mappings = @XmlListBinding.Mapping( element = "role-mapper", type = RoleMapper.class ) )
    ListProperty PROP_ROLE_MAPPERS= new ListProperty( TYPE, "RoleMappers" );

    ElementList<RoleMapper> getRoleMappers();
