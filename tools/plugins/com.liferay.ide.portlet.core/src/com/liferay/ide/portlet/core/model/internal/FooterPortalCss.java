...
public interface FooterPortalCss extends PortletStyleElement
{
    ...
    ValueProperty PROP_FOOTER_PORTAL_CSS = new ValueProperty( TYPE, "FooterPortalCss" );

    Value<Path> getFooterPortalCss();
    void setFooterPortalCss( String value );
    void setFooterPortalCss( Path value );
