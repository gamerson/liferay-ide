...
public interface FooterPortalJavascript extends PortletStyleElement
{
    ...
    ValueProperty PROP_FOOTER_PORTAL_JAVASCRIPT = new ValueProperty( TYPE, "FooterPortalJavascript" );

    Value<Path> getFooterPortalJavascript();
    void setFooterPortalJavascript( String value );
    void setFooterPortalJavascript( Path value );
}
