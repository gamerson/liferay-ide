 ...
 * @author Terry Jia
 */
@Component(properties = "OSGI-INF/AutoCorrectUpgradeProblemsStep.properties", service = UpgradeTaskStep.class)
public class AutoCorrectUpgradeProblemsStep extends AbstractUpgradeTaskStep {
