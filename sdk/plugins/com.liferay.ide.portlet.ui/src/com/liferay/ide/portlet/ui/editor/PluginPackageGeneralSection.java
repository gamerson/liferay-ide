...
public class PluginPackageGeneralSection extends IDESection implements IContextPart, IModelChangedListener
{
    ...
    {
        authorEntry = new FormEntry( client, toolkit, Msgs.author, null, false );
    ...
    {
        changeLogEntry = new FormEntry( client, toolkit, Msgs.changeLog, null, false );
    ...
    {
        licensesEntry = new FormEntry( client, toolkit, Msgs.licenses, null, false );
    ...
    {
        moduleGroupIdEntry = new FormEntry( client, toolkit, Msgs.moduleGroupId, null, false );
    ...
    {
        moduleIncrementalVersionEntry = new FormEntry( client, toolkit, Msgs.moduleVersion, null, false );
    ...
    {
        nameEntry = new FormEntry( client, toolkit, Msgs.name, null, false );
    ...
    {
        pageUrlEntry = new FormEntry( client, toolkit, Msgs.pageURL, null, false );
    ...
    protected void createShortDescriptionEntry( Composite client, FormToolkit toolkit, IActionBars actionBars )
    {
        ...
        shortDescriptionEntry = new FormEntry( client, toolkit, Msgs.shortDescription, null, false );
    ...
    {
        tagsEntry = new FormEntry( client, toolkit, Msgs.tags, null, false );
