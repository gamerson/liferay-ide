    ...
    implements ISDKProjectsImportDataModelProperties
{
    ...
    protected void createProjectsList( Composite workArea )
    {
        ...
        labelProjectsList.setText( Msgs.importProjects );
    ...
    {
        SWTUtil.createLabel( topComposite, SWT.LEAD, Msgs.liferayPluginSDKLocation, 1 );
        ...
        SWTUtil.createLabel( topComposite, SWT.LEAD, StringUtil.EMPTY, 1 );
    ...
    public void updateProjectsList( final String path )
    {
        ...
        {
            setMessage( Msgs.WizardProjectsImportPage_ImportProjectsDescription );
        ...
        try
        {
            getContainer().run( true, true, new IRunnableWithProgress()
            {
                ...
                {
                    monitor.beginTask( Msgs.WizardProjectsImportPage_SearchingMessage, 100 );
                    ...
                    if( dirSelected && directory.isDirectory() )
                    {
                        ...
                        monitor.subTask( Msgs.WizardProjectsImportPage_ProcessingMessage );
        ...
        if( displayWarning )
        {
            setMessage( Msgs.WizardProjectsImportPage_projectsInWorkspace, WARNING );
        }
        else
        {
            setMessage( Msgs.WizardProjectsImportPage_ImportProjectsDescription );
        ...
        {
            setMessage( Msgs.WizardProjectsImportPage_noProjectsToImport, WARNING );
        }
        // else {
    ...
    private static class Msgs extends NLS
    {
        ...
        public static String liferayPluginSDKLocation;
