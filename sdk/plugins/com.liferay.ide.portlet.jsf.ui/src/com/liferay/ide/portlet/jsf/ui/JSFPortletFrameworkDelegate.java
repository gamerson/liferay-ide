...
public class JSFPortletFrameworkDelegate extends AbstractPortletFrameworkDelegate implements IJSFPortletFrameworkProperties
{
    ...
    public Composite createNewProjectOptionsComposite( Composite parent )
    {
        ...
        (
            ...
            Msgs.componentsUtilizeLiferayAlloy,
        ...
        (
            group, 
            Msgs.primeFaces,
            Msgs.lightweightZeroConfigurationJsfUiFramework,
        ...
        (
            group, 
            Msgs.richFaces,
            Msgs.nextGenerationJSFComponentFramework,
    ...
    {
        public static String nextGenerationJSFComponentFramework;
        public static String lightweightZeroConfigurationJsfUiFramework;
        public static String componentsJQuery;
        public static String componentsUtilizeLiferayAlloy;
        public static String standardUIComponents;
