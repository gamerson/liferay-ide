...
public class LocationValidationService extends ValidationService
{
    ...
    protected Status compute()
    {
        ...
        if( ! op().getUseDefaultLocation().content( true ) )
        {
            ...
            /*
             * IDE-1150, instead of using annotation "@Required",use this service to validate 
             * the custom project location must be specified, let the wizard display the error of project name
             * when project name and location are both null.
             */
                ...
                if( currentProjectLocation != null )
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            {
                                retval = Status.createErrorStatus( "\"" + currentPath + "\" is not a valid project location." );
                            }
                        }
                    }
                }
