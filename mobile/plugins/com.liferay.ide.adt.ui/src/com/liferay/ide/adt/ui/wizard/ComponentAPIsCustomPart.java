        ...
        implements IColorProvider, DelegatingStyledCellLabelProvider.IStyledLabelProvider
    {
        ...
        public Image getImage( Object element )
        {
            if( element instanceof MobileAPI )
            {
                ...
                {
                    return ADTUI.imageDescriptorFromPlugin( ADTUI.PLUGIN_ID, "/icons/e16/liferay-core_16x16.png" ).createImage();
                }
                else
                {
                    return ADTUI.imageDescriptorFromPlugin( ADTUI.PLUGIN_ID, "/icons/e16/portlet_16x16.png" ).createImage();
                }
            }
            else if( element instanceof String )
            {
                return ADTUI.imageDescriptorFromPlugin( ADTUI.PLUGIN_ID, "/icons/e16/api_16x16.gif" ).createImage();
            }
