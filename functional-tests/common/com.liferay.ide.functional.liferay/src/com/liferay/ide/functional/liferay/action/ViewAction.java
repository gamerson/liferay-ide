...
public class ViewAction extends UIAction {
	...
	public class ServersViewAction {
		...
		public void refreshWatchProject(String serverName, String workspaceName, String projectName) {
			_getServers().selectTreeItem(serverName, workspaceName, projectName);

			_getServers().contextMenu(true, REFRESH, serverName, workspaceName, projectName);
		}
