...
package com.liferay.ide.core.base.action;

import com.liferay.ide.core.base.util.BundleInfo;
import com.liferay.ide.core.base.util.CSVReader;
import com.liferay.ide.core.base.util.ValidationMsg;
...
public class EnvAction {
	...
	public static EnvAction getInstance() {
		if (_envAction == null) {
			_envAction = new EnvAction();
		}
	...
	public IPath getBundlesPath() {
		if (_bundlesPath == null) {
			if ((_bundlesDir == null) || _bundlesDir.equals("") || _bundlesDir.equals("null")) {
				URL rootUrl = Platform.getBundle("com.liferay.ide.core.base").getEntry("/");

				try {
					String filePath = FileLocator.toFileURL(rootUrl).getFile();

					if (filePath.contains("target/work/configuration")) {
						int index = filePath.indexOf("/unit-tests/");
