...
public class ValidationFragmentTests extends SwtbotBase {
	...
	public void checkInitialState() {
		...
		validationAction.assertEquals(StringPool.BLANK, wizardAction.newProject.getProjectName());

		validationAction.assertEquals(PLEASE_ENTER_A_PROJECT_NAME, wizardAction.getValidationMsg(2));

		validationAction.assertCheckedTrue(wizardAction.newProject.getUseDefaultLocation());
		...
		validationAction.assertEquals(workspacePath, wizardAction.newProject.getLocation());
