...
public class WebsphereRuntimeDecorationsProvider implements IAdapterFactory {
	...
	public class WebsphereDecorationsProvider implements IDecorationsProvider {
		...
		public ImageDescriptor getIcon() {
			return WebsphereUI.imageDescriptorFromPlugin(WebsphereUI.PLUGIN_ID, "icons/e16/server.png");
		}
