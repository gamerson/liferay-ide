...
public class EditorPlugin extends AbstractUIPlugin {
	...
	public static final String PLUGIN_ID = "com.liferay.ide.color.editor.ui";
	public static final String STATUS_CATEGORY_MODE = PLUGIN_ID + ".modeStatus";
    ...
    public static ImageDescriptor getImageDescriptor(String imageName) {
        ...
        try {
			URL installURL = Platform.getBundle( getPluginId() ).getEntry( "/" );
