...
public class WebsphereServerBehavior extends PortalServerBehavior implements IWebsphereServerBehavior, IStreamListener
{
    ...
    public void addOperation(
        ...
        int deltaKind, boolean needClean )
    {
        switch( deltaKind )
        {
    ...
    public int getDefaultJMXRemotePort()
    {
    ...
    public void stop( boolean force )
    {
        ...
        try
        {
            ...
            try
            {
                String url = "http://" + getServer().getHost() + ":9060/ibm/console/login.do";

                stopedThread = new ServerStateStopThread( getServer(), url, this );
            }
            catch( Exception e )
            {
                LiferayServerCore.logError( "Can't ping for portal startup." );
