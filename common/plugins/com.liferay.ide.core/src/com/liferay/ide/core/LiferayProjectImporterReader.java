...
public class LiferayProjectImporterReader extends ExtensionReader<ILiferayProjectImporter>
{
    ...
    public ILiferayProjectImporter[] getImporters( String buildType )
    {
        final List<ILiferayProjectImporter> retval = new ArrayList<>();

        final ILiferayProjectImporter[] importers = getImporters();
        ...
        return retval.toArray( new ILiferayProjectImporter[0] );
    }
