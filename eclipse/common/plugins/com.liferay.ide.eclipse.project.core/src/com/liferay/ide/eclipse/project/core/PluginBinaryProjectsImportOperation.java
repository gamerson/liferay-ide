...
public class PluginBinaryProjectsImportOperation extends SDKProjectsImportOperation {
	...
	public IStatus execute( IProgressMonitor monitor, IAdaptable info ) throws ExecutionException {
		...
		if ( selectedProjects != null ) {
			...
			for ( Object object : seleBinaryRecords ) {
				...
				try {
					projectRecords[i++] = createPluginProject( pluginBinaryRecord, liferaySDK );
				}
				catch ( IOException e ) {
	 ...
	 * @throws IOException
	 */
	private ProjectRecord createPluginProject( PluginBinaryRecord pluginBinaryRecord, SDK liferaySDK )
		throws IOException {
